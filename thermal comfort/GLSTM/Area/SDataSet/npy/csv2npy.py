...
if __name__ == '__main__':
    ...
    file = ['../format/summer.csv', '../format/winter.csv']
    for f in file:
        ...
        print(count, person, env, avg, grf, diff)
        '''save data'''

        if f == '../format/summer.csv':
            save = 'summer'
        else:
            save = 'winter'
        np.save('./' + save + '/count.npy', count)
        np.save('./' + save + '/person.npy', person)
        np.save('./' + save + '/env.npy', env)
        np.save('./' + save + '/avg.npy', avg)
        np.save('./' + save + '/grf.npy', grf)
        np.save('./' + save + '/diff.npy', diff)
